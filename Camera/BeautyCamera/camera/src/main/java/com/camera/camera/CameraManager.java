...
import com.camera.framework.modules.channels.ChannelManager;
import com.camera.framework.modules.consumers.IVideoConsumer;
import com.camera.framework.modules.consumers.SurfaceViewConsumer;
...
public class CameraManager {
    ...
    private static class CameraManagerInstanceHolder {
    ...
    public static CameraManager getInstance() {
        return CameraManagerInstanceHolder.sInstance;
    }

    public void init(Context context, IPreprocessor preprocessor) {
