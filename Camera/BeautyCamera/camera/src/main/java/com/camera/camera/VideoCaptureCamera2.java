...
import com.camera.framework.helpers.gles.core.GlUtil;
    ...
    public boolean allocate(int width, int height, int frameRate, int facing) {
        ...
        try {
            for (String cameraId : mCameraManager.getCameraIdList()) {
                ...
                if (mFacing == Constant.CAMERA_FACING_FRONT && face == CameraCharacteristics.LENS_FACING_FRONT) {
                    mCamera2Id = cameraId;
                    break;
                }

                if (mFacing == Constant.CAMERA_FACING_BACK && face == CameraCharacteristics.LENS_FACING_BACK) {
                    mCamera2Id = cameraId;
                    break;
                }
            }
        ...
        if (cameraCharacteristics == null || mCamera2Id == null) {
            return false;
        }
